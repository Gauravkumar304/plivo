      ...
      <div className="flex w-full max-w-4xl shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/2 bg-white p-8">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-blue-900">Plivo</h2>
          ...
          <form className="mt-6">
            ...
            <div className="flex justify-between items-center">
              <button
                type="submit"
                className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-900 transition duration-200"
              >
                Login
              </button>
              <button
                className="ml-2 w-full bg-white border-2 border-blue-900 text-blue-900 px-4 py-2 rounded-lg hover:bg-blue-100 transition duration-200"
              >  
